...
<p className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 sm:max-w-lg pb-3'>Creating Meaningful connections and turning big ideas into interactive digital experiences.</p>
