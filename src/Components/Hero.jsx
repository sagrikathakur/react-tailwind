...
const Hero = () => {
  return (
    <div id = 'hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full
...
className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 sm:max-w-lg pb-3'>Creating Meaningful connections and turning big ideas into interactive digital experiences.</motion.p>
